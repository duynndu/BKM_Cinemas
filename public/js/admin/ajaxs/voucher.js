    ...
    `;
                                    ...
                                    modalBody.find(".overflow-auto").html(
                                        accountsHtml);
                                },
                        ...
                        $(".giftVoucher").on('click', function() {
                            ...
                            const arrayUserSelected = $('.form-check-input:checked')
                                .map(function() {
                                    return $(this)
                                        .val(); // Lấy giá trị (value) của từng checkbox
                                }).get(); // Chuyển thành mảng JavaScript

                            const userSelected = arrayUserSelected.filter(function(
                                userId) {
                                return userId !==
                                    'all'; // Loại bỏ phần tử "all"
            ...
            // xử lý các ô radio khi checked
            var checkedAllAccount = $("#checked_all_account");

            // Sự kiện khi nhấn vào nút "Chọn tất cả"
            checkedAllAccount.on("click", function() {
                // Chọn hoặc bỏ chọn tất cả các checkbox nhỏ
                $(".form-check-input").not("#checked_all_account").prop("checked", this.checked);
            });
            ...
            $(document).on("click", ".form-check-input", function() {
                ...
                var totalCheckboxes = $(".form-check-input").not("#checked_all_account").length;

                // Số lượng checkbox nhỏ được chọn
                var checkedCheckboxes = $(".form-check-input:checked").not("#checked_all_account").length;
