@extends('client.layouts.main-booking-order')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="st_bt_top_back_btn float_left"><a href="index.html"><i
                            ...
                            <div class="col-md-12">
                                <div class="st_dtts_ineer_box float_left">
                                    <ul>
                                        ...
                                        <li><span class="dtts1">Theater</span> <span
                                                class="dtts2">Ariesplex SL Cinemas</span>
                                        </li>
                            ...
                            <div class="col-md-12">
                                <div class="st_cherity_section float_left">
                                    <div class="st_cherity_img float_left">
                                        <img src="{{ asset('movie_2/images/content/cc1.jpg') }}" alt="img">
                                    </div>
                                    <div class="st_cherity_img_cont float_left">
                                        <div class="box">
                                            <p class="cc_pc_color1">
                                                <input type="checkbox" id="c201" name="cb">
                                                <label for="c201"><span>ADD Rs. 2</span> to your transaction as a donation.
                                                    (Uncheck if you do not wish to donate)</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
