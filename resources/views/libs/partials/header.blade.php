...
<div class="prs_main_slider_wrapper">
    <div class="prs_top_main_slider_wrapper">
        <div class="img_main">
            <img src="images/index_II/top-1.jpg">
        </div>
        <div class="img_main">
            <img src="images/index_II/top-2.jpg">
        </div>
        <div class="img_main">
            <img src="images/index_II/top-3.jpg">
        </div>
        <div class="img_main">
            <img src="images/index_II/top-4.jpg">
        </div>
        <div class="img_main">
            <img src="images/index_II/top-5.jpg">
        </div>
        <div class="img_main">
            <img src="images/index_II/top-6.jpg">
        </div>
    </div>
</div>
    ...
    <div class="prs_slider_upcom_heading_slider_wrapper">
        <div class="prs_top_main_upcom_slider_wrapper">
            <div class="img_main_up">
                <img src="images/index_II/bot-1.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
            <div class="img_main_up">
                <img src="images/index_II/bot-2.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
            <div class="img_main_up">
                <img src="images/index_II/bot-3.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
            <div class="img_main_up">
                <img src="images/index_II/bot-4.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
            <div class="img_main_up">
                <img src="images/index_II/bot-5.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
            <div class="img_main_up">
                <img src="images/index_II/bot-6.jpg">
                <h4><a href="#">Aquaman</a> &nbsp;&nbsp;<span>release on 30 nov</span></h4>
            </div>
        </div>
    </div>
            ...
            <div class="prs_logo_main_wrapper">
                <a href="index.html">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                         ...
                         width="46.996px" height="40px" viewBox="0 0 46.996 40" enable-background="new 0 0 46.996 40"
                         xml:space="preserve">
<g>
    <g>
