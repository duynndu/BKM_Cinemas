        ...
        <div style="border-collapse:collapse;padding:0;margin:0 auto;width:600px; margin-top: 80px !important;">
            <div class="email-container">
                ...
                <div class="email-body">
                    <p>BKM.vn xin thông báo, quý khách đã đổi mật khẩu thành công vào lúc {{ $time }}.</p>
                    <p>Xin hãy click vào nút phía bên dưới để "Đăng nhập".</p>
                    <div class="box-email-forgotpassword">
                        <a href="{{ url('/account') }}"
                            class="button_access">Đăng nhập ngay</a>
                    </div>
                    <div>
