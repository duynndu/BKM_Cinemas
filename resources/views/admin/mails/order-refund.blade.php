    ...
    <div style="border-collapse:collapse;padding:0;margin:0 auto;width:600px; margin-top: 80px !important;">
        <div class="email-container">
            <div class="email-header">
                ...
                <h1>Yêu cầu hoàn tiền thành công</h1>
            </div>
            <div class="email-body">
                <p>Vé có mã: {{ $order['code'] }}</p>
                <p><b>Ngày, giờ hoàn tiền: </b> {{ $time }}</p>

                <p><b>Số tiền hoàn lại: </b> {{ number_format($order['total_price'], 0, '.', ',') }} VND</p>
                <div>
