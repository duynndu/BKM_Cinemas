        ...
        <div class="email-body">
            ...
            <div class="email-content">
                ...
                <div class="left-section">
                    ...
                    <div  class="voucher-code" style="display: flex">
                        <a href="{{ route('account') }}">{{ $voucher->code }}</a>
                        <a href="{{ route('account') }}" style="padding: 10px; margin-left:10px; color:white;background-color: rgb(35, 35, 167)">Xem ngay</a>
                    </div>
