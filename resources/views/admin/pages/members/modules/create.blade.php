    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form method="post" action="{{ route('admin.modules.store') }}" class="product-vali"
                            ...
                            <div class="card h-auto">
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <label
                                                class="form-label mb-2">{{ __('language.admin.members.modules.name') }}</label>
                                            <input type="text" id="name" name="module[name]" class="form-control"
                                                placeholder="{{ __('language.admin.members.modules.inputName') }}"
                                                value="{{ old('module.name') }}">
                                            @error('module.name')
                                                <div class="mt-2">
                        ...
                        <div class="col-xl-4">
                            <div class="right-sidebar-sticky">
                                <div class="mt-3 d-flex justify-content-start gap-2">
                                    <button type="submit"
                                        class="btn btn-success">{{ __('language.admin.members.modules.createNew') }}</button>
                                    <a href="{{ route('admin.modules.index') }}"
                                        class="btn btn-warning">{{ __('language.admin.members.modules.back') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
