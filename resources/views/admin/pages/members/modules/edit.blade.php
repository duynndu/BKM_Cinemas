                            ...
                            <div class="card h-auto">
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control"
                                                   placeholder="{{ __('language.admin.members.modules.inputName') }}" value="{{ old('name') ?? $data['module']->name }}">
                                            @error('name')
                                            <div class="mt-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" cols="20" rows="5" name="description">{{ old('description') ?? $data['module']->description }}</textarea>
                                        @error('description')
                                        <div class="mt-2">
                                            <span class="text-red">{{ $message }}</span>
                                        </div>
