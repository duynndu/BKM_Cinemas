                                ...
                                <div class="card-body">
                                            ...
                                            <select class="form-control w-50" name="permission[module_id]">
                                                ...
                                                @if($data['modules']->isNotEmpty())
                                                    @foreach($data['modules'] as $module)
                                                        <option
                                                            @selected(old('permission.module_id', $data['permission']->module_id) == $module->id)
                                                            value="{{ $module->id }}">
                                                            {{ $module->name }}
                                                        </option>
                                                    @endforeach
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control"
                                               placeholder="{{ __('language.admin.members.permissions.inputValue') }}" name="permission[value]" value="{{ old('permission.value', $data['permission']->value) }}">
