                        ...
                        <div class="col-xl-8">
                            <div class="card h-auto">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <label
                                            class="form-label mb-2">{{ __('language.admin.posts.description') }}</label>
                                            ...
                                            <select multiple class="form-control" name="parent_id[]">
                                                ...
                                                @if ($listCategoryPost)
                                                    @foreach ($listCategoryPost as $category)
                                                        <option
                                                            value="{{ $category->id }}" @selected(in_array($category->id, old('parent_id', [])))>
                                                            {{ $category->name }}
                                                        </option>
                                ...
                                <div class="filter cm-content-box box-primary">
                                    ...
                                    <div class="cm-content-body publish-content form excerpt">
                                        <div class="card">
                                            <div class="card-body">
                                                <label
                                                    class="form-label">{{ __('language.admin.posts.tagTitle') }}</label>
                                                ...
                                                <select name="tags[]" id="multi-value-select" style="width:100%;"
                                                    ...
                                                    @foreach ($tags as $tag)
                                                        <option
                                                            @selected(in_array($tag->id, old('tags', [])))  data-select2-id="select2-data-{{ $tag->id }}-jw2f">
                                                            {{ $tag->name }}</option>
                                                    @endforeach
                                                </select>
