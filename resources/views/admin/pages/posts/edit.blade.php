                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="title_seo" name="title_seo"
                                                   ...
                                                   placeholder="{{ __('language.admin.posts.inputTitle') }}">
                                            @error('title_seo')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="keyword_seo" name="keyword_seo"
                                                   ...
                                                   placeholder="{{ __('language.admin.posts.inputKeyword') }}">
                                            @error('keyword_seo')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_seo" id="description_seo" class="form-control"
                                                      cols="30"
                                                      rows="10">{{ old('description_seo', $post->description_seo) ?? '' }}</textarea>
                                                    ...
                                                    <select class="form-control" multiple name="language_id[]"
                                                        ...
                                                        @if(!empty($languages))
                                                            @foreach($languages as $language)
                                                                <option
                                                                    @selected(in_array($language->id, old('language_id', $languagesTransactions)))
                                                                    value="{{ $language->id }}">
                                                                    {{ $language->name }}
                                                                </option>
                                                            @endforeach
                                            ...
                                            <div class="col-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-check-input"
                                                           {{ $post->active == 0 ? 'checked' : '' }} type="radio"
                                                           id="active" name="active" value="0">
                                                    <label class="form-check-label" for="active">
                                            ...
                                            <div class="col-6">
                                                <div class="card-body">
                                                    ...
                                                    <input
                                                        ...
                                                        type="checkbox" id="hot" name="hot" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
