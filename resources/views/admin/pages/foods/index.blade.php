                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2 col-sm-4 mb-3 mb-xl-0">
                                                ...
                                                <div class="dropdown bootstrap-select form-control">
                                                    <select name="foodTypes" class="form-control">
                                                        <option value="">
                                                            --chọn--
                                                        </option>
                                                        @if ($listFoodTypes)
                                                            @foreach ($listFoodTypes as $foodType)
                                                                <option @selected( request()->foodTypes == $foodType->id ) value="{{ $foodType->id }}">
                                                                    {{ $foodType->name }}
                                                                </option>
                                                            @endforeach
                                                        @endif
                                    ...
                                    <div class="d-flex justify-content-center align-items-center p-5">
                                        <div>
                                            <h3 class="text-center">
                                                {{ request()->name ? __('language.admin.posts.noDataSearch') . request()->name : __('language.admin.posts.noData') }}
                                            </h3>
                                        </div>
                                    </div>
                                @endif
