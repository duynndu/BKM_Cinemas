                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2  col-sm-4 mb-3 mb-xl-0">
                                                <label
                                                    class="form-label">{{ __('language.admin.systems.active') }}</label>
                                                <select name="active" class="form-control">
                                                    <option value="" {{ request()->active === null ? 'selected' : '' }}>
                                                        -- {{ __('language.admin.systems.select') }} --
                                                    </option>
                                                    <option
                                                        value="1" {{ request()->active == '1' ? 'selected' : '' }}>{{ __('language.admin.systems.show') }}</option>
                                                    <option
                                                        value="0" {{ request()->active == '0' ? 'selected' : '' }}>{{ __('language.admin.systems.hidden') }}</option>
                                                </select>
                                            </div>
                                            <div class="col-xl-6 col-sm-6 align-self-end">
                                                <div>
                                                    <button class="btn btn-primary me-2"
                                                            title="{{ __('language.admin.systems.search') }}"
                                                            type="submit">
                                                        <i class="fa-sharp fa-solid fa-filter me-2"></i>
                                        ...
                                        @if(!$systemBySystemId->isEmpty())
                                            <table class="table table-responsive-md" id="data-table">
                                                ...
                                                <tr>
                                                    ...
                                                    @endcan
                                                    @if(auth()->user()->can('update', \App\Models\System::class) || auth()->user()->can('delete', \App\Models\System::class))
                                                ...
                                                @foreach($systemBySystemId as $key => $system)
                                                    <tr>
                                                        <td><input type="checkbox" data-id="{{ $system->id }}"
