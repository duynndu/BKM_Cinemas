                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="row gx-0">
                                        ...
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="drive">
                                                <div class="dz-folder">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="35" height="40" viewBox="0 0 512 512">
                                                ...
                                                <div class="drive-content">
                                                    <h5>{{ __('language.admin.interfaces.blockTypes.have') }}: {{ $countBlockType }} {{ __('language.admin.interfaces.blockTypes.blockType_sample') }}</h5>
                                                    <div class="progress default-progress">
                                                        <div class="progress-bar bg-vigit progress-animated bg-primary"
                                                            style="width: {{ $countBlockType }}%; height:100%;" role="progressbar">
                                                    ...
                                                    <div class="dz-info">
                                                        ...
                                                        <div class="mt-1 d-flex justify-content-center align-items-center">
                                                            ...
                                                            <form
                                                                ...
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="text-hover bt-form btnDelete">{{ __('language.admin.interfaces.blockTypes.delete') }}</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
