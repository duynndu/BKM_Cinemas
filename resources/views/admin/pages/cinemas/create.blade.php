                                    ...
                                    <div class="row mb-4">
                                        <div class="actor-row row mt-2">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" value="{{ old('cinema.address') }}"
                                            ...
                                            <div class="col-4 p-3">
                                                ...
                                                <input type="text" value="{{ old('cinema.phone') }}"
                                                    name="cinema[phone]" placeholder="Nhập số điện thoại" class="form-control">
                                                @error('cinema.phone')
                                                    <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-4 p-3">
                                                ...
                                                <input type="text" value="{{ old('cinema.email') }}"
