                        ...
                        <table class="table table-responsive-md" id="data-table">
                            ...
                            <tbody class="fs-4" x-data="{
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-max-w-[250px] tw-text-white tw-bg-[#2d3748] hover:tw-bg-[#4a5568] tw-p-4 tw-cursor-pointer tw-flex tw-items-center tw-gap-2 tw-transition-all tw-duration-300 tw-line-height-[1.7] tw-text-[0.9rem] tw-border tw-border-[var(--border)] tw-h-[3rem] tw-rounded-[0.5rem]">
                                    ...
                                    <td>
                                        <div @click="'{{$seatType->is_system}}' ? editSeatType($event) : ''">
                                            ...
                                            <x-destroy-button route="admin.seat-types.destroy" id="{{ $seatType->id }}" />
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
