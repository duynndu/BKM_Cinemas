    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                ...
                <form method="post" action="{{ route('admin.tags.store') }}" class="product-vali">
                    @csrf
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card h-auto">
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control"
                                                placeholder="{{ __('language.admin.tags.inputFilterName')}}" value="{{ old('name') }}">
                                            @error('name')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug"
                                                placeholder="{{ __('language.admin.tags.inputSlug')}}" value="{{ old('slug') }}">
                                            @error('slug')
                                                <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea placeholder="{{ __('language.admin.tags.inputDescription')}}" class="form-control" cols="20" rows="5" name="description">{{ old('description')}}</textarea>
                                        @error('description')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-xl-4">
                            <div class="right-sidebar-sticky">
                                ...
                                <div class="mt-3 d-flex justify-content-start gap-2">
                                    <button type="submit" class="btn btn-success">{{ __('language.admin.tags.addNew')}}</button>
