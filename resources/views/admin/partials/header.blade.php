                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media-body">
                                                        ...
                                                        <small class="d-block">
                                                            Lúc {{ $item->created_at->format('h:i A') }} {{ $item->created_at->format('d') }} Tháng {{ $item->created_at->format('m') }}, {{ $item->created_at->format('Y') }}
                                                        </small>
                                                    </div>
                                                </div>
                                            </li>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form action="{{ route('admin.logout') }}" method="POST">
                                    ...
                                    <button class="dropdown-item ai-icon">
                                        ...
                                        <span class="ms-2 text-danger">{{ __('language.admin.accounts.logout') }}
                                        </span>
                                    </button>
                                </form>
                            </div>
