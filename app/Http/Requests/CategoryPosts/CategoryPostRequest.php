...
class CategoryPostRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            "name" => [
                ...
                "min:3",
                "max:255",
                new CheckRuleName($id, 'category_posts')
            ],
            'slug' => [
                "required",
                "min:3",
            ...
            'position' => [
                function ($attribute, $value, $fail) use ($id) { // $id là ID của bản ghi hiện tại
                    if ($value > 0) {
                        ...
                        if (CategoryPost::where('position', $value)
    ...
    public function messages()
    {
        return [
            ...
            "position.unique" => __('validation.unique', ['attribute' => __('language.admin.categoryPosts.position')]),
        ];
    }
}
