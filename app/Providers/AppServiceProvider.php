...
use App\Repositories\Client\Movies\Interface\MovieInterface as MovieInterfaceClient;
use App\Repositories\Auth\Client\ForgotPasswords\Repository\ForgotPasswordRepository;
use App\Repositories\Client\Movies\Repository\MovieRepository as MovieRepositoryClient;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ListMovieInterface::class, ListMovieService::class);
        $this->app->bind(MovieInterfaceClient::class, MovieRepositoryClient::class);
        // End client
    }
